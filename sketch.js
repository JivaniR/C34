...
var blink,eat,sad;
var mute_btn;
var star1,star2,starImg_1;
var fr;
var emptyStar,oneStar,twoStar,starsDisplay;
var bk_song;
var cut_sound;
var sad_sound;
var eating_sound;
...
star1.addImage("abc",starImg_1);
star1.scale= 0.02;

star2= createSprite(50,370,20,20);
star2.addImage("abc",starImg_1);
star2.scale= 0.02;

starsDisplay= createSprite(50,20,30,30);
starsDisplay.addImage("empty",emptyStar);
starsDisplay.addImage("one",oneStar);
starsDisplay.addImage("two",twoStar);
starsDisplay.scale= 0.2;
starsDisplay.changeImage("empty");
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star1,20)==true){
    star1.visible= false;
    starsDisplay.changeImage("one");
  }
  
  if(collide(fruit,star2,20)==true){
    star2.visible= false;
    starsDisplay.changeImage("two");
  }
